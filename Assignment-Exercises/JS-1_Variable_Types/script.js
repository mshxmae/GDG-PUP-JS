...
// Using let
let name = "Maeryl Venida";// Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["gaming", "reading"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["Bee Keeper", "Days at the Morisaki Bookshop"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Shibuya"; // Define a string here, e.g., "New York"
var temperature = 36.7; // Define a number here, e.g., 22.5
var hasPets = false; // Define a boolean here, e.g., true or false
var colors = ["black","white","gray"]; // Define an array here, e.g., ["red", "green", "blue"]
